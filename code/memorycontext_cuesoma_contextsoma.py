...
data_path = '/users/ntolley/data/ntolley/dendractor/memorycontext_cuesoma_contextsoma'


def update_prior_dict_cuesoma_contextsoma(prior_dict):
...
if __name__ == "__main__":
    ...
    update_prior_dict_cuesoma_contextsoma(prior_dict)
