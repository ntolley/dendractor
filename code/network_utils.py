...
from networkx import adjacency_matrix, gaussian_random_partition_graph, connected_watts_strogatz_graph
...
def set_train_parameters(net, gid_ranges):
    ...
    net.set('cue_ampa_k_minus', 0.1)
    net.set('context_ampa_k_minus', 0.1)
