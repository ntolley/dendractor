...
data_path = '/users/ntolley/data/ntolley/dendractor/memorycontext_cuesoma_contextsoma_cellsoma_expandedprior'


def update_prior_dict_cuesoma_contextsoma_cellsoma_expandedprior(prior_dict):
    prior_dict['cue_ampa_gS']['bounds'] = (-9, -2)
    prior_dict['context_ampa_gS']['bounds'] = (-9, -2)
    ...
    prior_dict['IE_gaba_pconn']['bounds'] =  (0, 1.0)
    prior_dict['EE_ampa_pconn']['bounds'] = (0, 1.0)
...
if __name__ == "__main__":
    ...
    update_prior_dict_cuesoma_contextsoma_cellsoma_expandedprior(prior_dict)
