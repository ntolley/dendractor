...
data_path = '/users/ntolley/data/ntolley/dendractor/memorycontext_cuesoma_contextdend'

def update_prior_dict_cuesoma_contextdend(prior_dict):
...
if __name__ == "__main__":
    ...
    update_prior_dict_cuesoma_contextdend(prior_dict)
